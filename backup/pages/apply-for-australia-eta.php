...
Information Act is given on Form 424a Request for access to documents or
 information (PDF).
				...
				<div class="span4">
				  ...
				  <ul>
					<li> eta-australia.com has implemented a Instant Payment Notification (IPN) system, which allows your eTA application to be processed immediately. The cost of each individual application is $100. Your eTA authorization is delivered electronically direct to your e-mail. </li>
				  </ul>
				  <h3>SECURE SSL TRANSACTION</h3>
				  <ul>
					<li> to  eta-australia.com operates within full observance of the international regulations of the Standard Payment Card Industry – Data Security Standard (PCI-DSS) laid down by the main credit companies for protecting their clients' personal information. </li>
				  </ul>
